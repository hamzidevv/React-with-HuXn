...
const Sidebar = () => {
  ...
  return (
    <div className="relative flex justify-center items-center h-screen w-full bg-gray-950">
      {/* Backdrop */}
      <motion.div
        ...
        <div className="p-4">
          <button
            ...
            className="absolute top-4 right-4 z-10 p-2 bg-gray-800
             text-white rounded-full cursor-pointer focus:outline-none"
          >
      ...
      <button
        ...
        className={`absolute top-4 left-4 z-10 p-2 bg-gray-800
         text-white rounded-full cursor-pointer focus:outline-none ${isOpen ? "hidden" : ""}`}
      >
        {!isOpen && (
