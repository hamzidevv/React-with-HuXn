  ...
  return (
    <div className="flex flex-col items-center p-5">
      <div className="relative flex justify-between w-[40rem] mb-5">
        <motion.div
          className="absolute left-1 h-1 bg-blue-500 mt-[1rem]"
          style={{
        ...
        {steps.map((step, index) => (
          <div key={index} className="flex flex-col items-center relative">
            <motion.div
              className={`h-10 w-10  flex justify-center items-center rounded-full border-2 cursor-pointer ${
            ...
            >
              {index < currentStep ? <FiCheck className="text-white" /> : null}
            </motion.div>
            <p
              className={`mt-2 ${
